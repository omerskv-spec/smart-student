  ...
  return (
    <div className="bg-[#F5F4EF] border-t border-[rgba(0,0,0,0.08)]">
      ...
      <div className="p-3">
        ...
        <div className={`flex gap-2 items-end bg-white border rounded-2xl px-3 py-2.5 transition-all shadow-sm ${value ? 'border-[rgba(0,0,0,0.22)]' : 'border-[rgba(0,0,0,0.08)]'}`}>
          <FileUpload token={token} conversationId={conversationId} onUpload={handleUpload} onError={handleError} />
          <textarea
            ref={ref}
            value={value}
          ...
          <button
            ...
            className="w-8 h-8 bg-[#1A1A1A] hover:bg-[#2A2A2A] disabled:bg-[rgba(0,0,0,0.08)] disabled:cursor-not-allowed text-white rounded-xl flex items-center justify-center flex-shrink-0 transition-all"
